...
export declare const makeVBannerProps: <Defaults extends {
    ...
    location: unknown extends Defaults["location"] ? PropType<import("vuetify/lib/util/index.mjs").Anchor | null> : {
        type: PropType<unknown extends Defaults["location"] ? import("vuetify/lib/util/index.mjs").Anchor | null : import("vuetify/lib/util/index.mjs").Anchor | Defaults["location"] | null>;
...
export declare const VBanner: {
    ...
    location: PropType<import("vuetify/lib/util/index.mjs").Anchor | null>;
    elevation: {
        type: (StringConstructor | NumberConstructor)[];
        validator(v: any): boolean;
    };
