...
import type { Color } from "vuetify/lib/util/index.mjs";
...
export declare const VColorPicker: {
    ...
    showSwatches: boolean;
    swatchesMaxHeight: string | number;
}, {}, string, {}, import("vue").GlobalComponents, import("vue").GlobalDirectives, string, import("vue").ComponentProvideOptions> & import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps & import("vuetify/lib/util/index.mjs").FilterPropsOptions<{
    theme: StringConstructor;
    tag: {
        type: PropType<string | import("vuetify/lib/util/index.mjs").JSXComponent>;
        default: string;
