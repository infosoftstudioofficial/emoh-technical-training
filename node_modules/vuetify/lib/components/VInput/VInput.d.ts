...
import type { VMessageSlot } from "vuetify/lib/components/VMessages/VMessages.mjs";
...
export declare const makeVInputProps: <Defaults extends {
    ...
    rules: unknown extends Defaults["rules"] ? {
        type: PropType<readonly (import("vuetify/lib/composables/validation.mjs").ValidationRule | import("vuetify/labs/rules").ValidationAlias)[]>;
        default: () => never[];
    } : Omit<{
        type: PropType<readonly (import("vuetify/lib/composables/validation.mjs").ValidationRule | import("vuetify/labs/rules").ValidationAlias)[]>;
        default: () => never[];
...
}, slots: VInputSlots) => GenericProps<typeof props, typeof slots>) & import("vuetify/lib/util/index.mjs").FilterPropsOptions<{
