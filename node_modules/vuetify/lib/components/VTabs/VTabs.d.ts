...
export declare const makeVTabsProps: <Defaults extends {
    ...
    mobileBreakpoint: unknown extends Defaults["mobileBreakpoint"] ? PropType<number | import("vuetify/lib/types.mjs").DisplayBreakpoint> : {
        type: PropType<unknown extends Defaults["mobileBreakpoint"] ? number | import("vuetify/lib/types.mjs").DisplayBreakpoint : number | import("vuetify/lib/types.mjs").DisplayBreakpoint | Defaults["mobileBreakpoint"]>;
...
export declare const VTabs: {
    ...
    items?: T[];
}, slots: VTabsSlots<T>) => GenericProps<typeof props, typeof slots>) & import("vuetify/lib/util/index.mjs").FilterPropsOptions<{
    tag: {
        type: PropType<string | import("vuetify/lib/util/index.mjs").JSXComponent>;
        default: string;
    };
    ...
    mobileBreakpoint: PropType<number | import("vuetify/lib/types.mjs").DisplayBreakpoint>;
