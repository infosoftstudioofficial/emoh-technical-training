...
export declare const VValidation: {
...
}, slots: VValidationSlots) => GenericProps<typeof props, typeof slots>) & import("vuetify/lib/util/index.mjs").FilterPropsOptions<{
    ...
    rules: {
        type: import("vue").PropType<readonly (import("vuetify/lib/composables/validation.mjs").ValidationRule | import("vuetify/labs/rules").ValidationAlias)[]>;
        default: () => never[];
    };
    modelValue: null;
